...
//    private PhongModel phongModel = new PhongModel(maPhong, loaiPhong, giaPhong, tinhTrang);
//
//    public HoaDonView() {
...
//            }
//            if (found.isEmpty() && !maKhachHang.isEmpty()) {
//                try {
